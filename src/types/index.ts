...
export interface Product {
  ...
  // backend returns full objects; for writes we send *_id
  ...
  // pricing (reads)
  price?: string;                         // computed base by country
  discounted_price?: string;              // computed discounted by country
  currency?: "INR" | "USD" | "AED";

  // pricing (raws, optional in reads/writes)
